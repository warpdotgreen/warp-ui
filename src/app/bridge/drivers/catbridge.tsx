...
import { BRIDGING_PUZZLE_HASH, getMessageCoinPuzzle1stCurry, getSecurityCoinSig, RawMessage, receiveMessageAndSpendMessageCoin, spendOutgoingMessageCoin } from './portal';
import { SExp, Tuple, getBLSModule } from "clvm";
...
export async function unlockCATs(
  ...
  /* lastly, aggregate sigs  and build spend bundle */
  const sb = await buildSpendBundle(coinSpends, sigStrings);
