...
import MessagesDelivered from "./components/MessagesDelivered"
      ...
      <main id="scrollContainer" className="relative px-4 sm:px-8 py-4 pb-20">
        <section className="mx-auto min-h-[calc(100vh-144px)] flex justify-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="bg-accent border rounded-lg p-2 w-full mt-auto animate-in fade-in duration-500">
              <div className="px-4 flex flex-col my-4 mb-8 w-full">
                <p className="text-xl">Latest Messages</p>
              </div>
