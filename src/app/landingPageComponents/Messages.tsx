...
function Messages() {
  ...
  const formatMessage = (m: MessageResponse, i: number) => {
    ...
    return (
      <div key={m.id} className={cn("rounded-md mb-2 w-full p-4 bg-accent/50 hover:bg-accent/90 transition-colors border z-10 animate-in fade-in slide-in-from-bottom-2 duration-500 flex flex-col gap-0", i + 1 > 4 && 'hidden 2xl:flex')}>
